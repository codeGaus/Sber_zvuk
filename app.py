...
def recognize():
    ...
    source = request.args.get('source', default='https://lmusic.kz/api/download/52233', type=str)
    ...
    pass  # передаем в модель, получаем результат

    print("Uploading content to amazon bucket...")
    s3.upload_file('content/wqe.mp4', 'hackathon-ecs-49', f'{prefix}.mp4')
